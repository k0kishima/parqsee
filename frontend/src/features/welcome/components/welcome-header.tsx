            ...
            <div className="px-6 py-4 flex items-center justify-between">
                <div className="flex items-center space-x-4">
                    <div className="flex items-center space-x-2">
                        ...
                        <h1 className={`text-xl font-semibold ${effectiveTheme === 'dark' ? 'text-gray-100' : 'text-slate-900'}`}>Parqsee</h1>
                    </div>
                    <span className={`text-sm ${effectiveTheme === 'dark' ? 'text-gray-400' : 'text-slate-500'}`}>Fast and simple Parquet file viewer</span>
                </div>
